...
public class EliminarUsuarioTest {
    ...
    @Test
    public void EliminarUsuarioTest() throws InterruptedException {
        ...
        // Se comprueba que se ha eliminado el usuario intentando iniciar sesion con los mismos credenciales
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("jorge"), closeSoftKeyboard());
