...
import com.example.proyecto.ui.Eventos.DeleteEventDialog;
                        ...
                        botonModificar.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if(evento.getEsMunicipio() == true) {
                                    NavHostFragment.findNavController(DetallesEvento.this).navigate(R.id.action_detallesEvento_to_nav_modificar_evento);
                                }
                                else{
                                    NavHostFragment.findNavController(DetallesEvento.this).navigate(R.id.action_nav_detalles_evento_to_nav_modificar_evento_montana);
                                }
